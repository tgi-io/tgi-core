...
```
<blockquote><strong>log: </strong>0.0.28<br></blockquote>
####Constructors
...
```
<blockquote><strong>log: </strong>Sun Jan 25 2015 09:46:42 GMT-0500 (EST)<br>returns <strong>true</strong> as expected
</blockquote>
#### modelID
...
```
<blockquote><strong>log: </strong>Sun Jan 25 2015 09:46:42 GMT-0500 (EST)<br>returns <strong>ModelID(Model:null)</strong> as expected
</blockquote>
#### attributeValues
...
```
<blockquote><strong>log: </strong>Sun Jan 25 2015 09:46:42 GMT-0500 (EST)<br></blockquote>
#### LOG TYPES
