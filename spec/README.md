...
```
<blockquote><strong>log: </strong>0.4.7<br></blockquote>
####Constructors
...
```
<blockquote><strong>log: </strong>Fri Oct 23 2015 10:02:50 GMT-0400 (EDT)<br>returns <strong>true</strong> as expected
</blockquote>
#### modelID
...
```
<blockquote><strong>log: </strong>Fri Oct 23 2015 10:02:50 GMT-0400 (EDT)<br>returns <strong>ModelID(Model:null)</strong> as expected
</blockquote>
#### attributeValues
...
```
<blockquote><strong>log: </strong>Fri Oct 23 2015 10:02:50 GMT-0400 (EDT)<br></blockquote>
#### LOG TYPES
