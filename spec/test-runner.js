...
(function () {
  ...
  function runBootstrapTests(TGI) {
    ...
    try {
      ...
      bootstrapThrows('new tgi.Spec.paragraph requires text argument', Error('Spec.paragraph requires text argument'), function () {
      ...
      bootstrapThrows('new tgi.Spec.heading requires text argument', Error('Spec.heading requires text argument'), function () {
      ...
      bootstrapThrows('new tgi.Spec.example requires text argument', Error('Spec.example requires text argument'), function () {
      ...
      bootstrapThrows('new tgi.Spec.example 3rd arg is function (code for example)', Error('Spec.example 3rd arg is function code or undefined'), function () {
